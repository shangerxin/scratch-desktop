const saveFilters = {
    ...
    SB: {
        name: 'KidsProgram 1 Project',
        extensions: ['sb']
    },
    SB2: {
        name: 'KidsProgram 2 Project',
        extensions: ['sb2']
    },
    SB3: {
        name: 'KidsProgram 3 Project',
        extensions: ['sb3']
    },
    Sprite2: {
        name: 'KidsProgram 2 Sprite',
        extensions: ['sprite2']
    },
    Sprite3: {
        name: 'KidsProgram 3 Sprite',
        extensions: ['sprite3']
    },
    SVG: {
        name: 'SVG Image',
